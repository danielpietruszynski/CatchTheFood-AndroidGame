...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int score = getIntent().getIntExtra("Wynik", 0);
        ...
        if (score > highScore) {
            ...
            //Aktualizacja najelpszego wyniku
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putInt("HIGH_SCORE", score);
            editor.apply();

            // highScoreLabel.setText("Najlepszy wynik : " + score);
            highScoreLabel.setText(getString(R.string.high_score, score));

        } else {
            // highScoreLabel.setText("Najlepszy wynik : " + highScore);
